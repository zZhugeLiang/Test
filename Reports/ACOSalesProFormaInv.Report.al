report 50017 "ACO Sales - Pro Forma Inv"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ACOSalesProFormaInv.rdlc';
    WordLayout = './ACOSalesProFormaInv.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                // Captions <<
                column(ACOProfileCode_SalesInvoiceLineCaption; Line.FieldCaption("ACO Profile Code")) { }
                column(ACOProfileDescription_SalesInvoiceLineCaption; Line.FieldCaption("ACO Profile Description")) { }
                column(ACOCustomerItemNo_SalesInvoiceLineCaption; Line.FieldCaption("ACO Customer Item No.")) { }
                column(ACOProfileCustDescription_SalesInvoiceLineCaption; Line.FieldCaption("ACO Profile Cust. Description")) { }
                ...
                column(ACOSawing_SalesInvLineCaption; Line.FieldCaption("ACO Sawing")) { }
                // Captions >>
                // Values <<
                column(ACOProfileCode_SalesInvoiceLine; Line."ACO Profile Code") { }
                column(ACOProfileDescription_SalesInvoiceLine; Line."ACO Profile Description") { }
                column(ACOCustomerItemNo_SalesInvoiceLine; Line."ACO Customer Item No.") { }
                column(ACOProfileCustDescription_SalesInvoiceLine; Line."ACO Profile Cust. Description") { }
