codeunit 50005 "ACO Create Prod. Order Lines"
{
    ...
    begin
        ...
        CreateProdOrderLine(ProdOrder, SalesLine, ErrorOccured);
    ...
    local procedure CreateProdOrderLine(ProdOrder: Record "Production Order"; SalesLine: Record "Sales Line"; var ErrorOccured: Boolean)
    var
        SalesHeader: Record "Sales Header";
    begin
        ...
        case ProdOrder."Source Type" of
            ...
            ProdOrder."Source Type"::"Sales Header":
                begin
                    ...
                    if not CopyFromSalesOrder(SalesHeader, SalesLine) then
                        ErrorOccured := true;
                end;
        end;
